...
old_client_requests_link = (
    "https://www.linkedin.com/profinder/requests?trk=services_seo_home_client_requests"
)
    ...
    try:
        ...
        if driver.current_url == login_link:
            try:
                ...
                # print(email_field)
                email_field.send_keys(UserConfig.email)
                print("Email Entered")
                # time.sleep(1)
                password_field = driver.find_element(By.ID, "password")
                # print(password_field)
                password_field.send_keys(UserConfig.password)
                ...
                print(
                    'Email and/or Password field not found, please enter the missing information and press "Sign in".\n'
                )
                pass
...
def check_for_proposals():
    while True:
        ...
        submit_proposal_button = driver.find_elements_by_class_name(
            "service-marketplace-provider-service-requests-detail__metadata-action"
        )
    ...
    proposal_text_field[0].send_keys(UserConfig.proposalScript)
    print("Custom Message Entered\n")
    # time.sleep(5)

    # CLICK NOT WORKING #
    # if Info.freeConsultation:
    ...
    continue_proposal_button = driver.find_elements(
        By.CSS_SELECTOR,
    ...
    send_proposal_button = driver.find_elements(
        By.CSS_SELECTOR,
        ".artdeco-button.artdeco-button--2.artdeco-button--primary.ember-view",
    )
    ...
    for element in send_proposal_button:
        if "Submit" == element.get_attribute("innerText"):
            ...
            with open("sent_proposals.csv", "a", newline="") as file:
                ...
                writer.writerow(
                    [date_csv_str, time_csv_str, name, desc]
...
def close_messages():
    close_message_button = driver.find_elements_by_xpath(
        "//*[@class='msg-overlay-bubble-header__control' and @class='artdeco-button artdeco-button--circle' and @class='artdeco-button--muted' and @class='artdeco-button--1' and @class='artdeco-button--tertiary' and @class='ember-view']"
    )
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            print("-" * 75)
            print("Error Detected - Restarting CamFinder V1 Now")
            print(e)
            print("-" * 75)
